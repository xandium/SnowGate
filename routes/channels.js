...
// Create Reaction
router.put(
  "/channels/:id/messages/:message_id/reactions/:emoji/@me",
  async (req, res) => {
    return utils.wrapRequest(
      req.rest,
      "channel",
...
// Delete Reaction
router.delete(
  "/channels/:id/messages/:message_id/reactions/:emoji/:user_id",
  async (req, res) => {
    return utils.wrapRequest(
      req.rest,
      "channel",
...
router.delete(
  "/channels/:id/messages/:message_id/reactions",
  async (req, res) => {
    return utils.wrapRequest(
      req.rest,
      "channel",
